...
print(etherdelta.balance_of_token(Address('0xd4fa1460F537bb9085d22C7bcCB5DD450Ef28e3a'), Address('0x5e1947255a753acae2931de90282776677a94a54')))
...
print(etherdelta.available_volume(offchain_order))
...
print(onchain_order)
print(etherdelta.available_volume(onchain_order))
